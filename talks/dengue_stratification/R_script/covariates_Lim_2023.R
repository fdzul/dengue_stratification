...
DiagrammeR::grViz("digraph {
                  ...
                  cluster [label = 'Cluster Análisis',  fillcolor =  'orange', color = 'white', fontcolor = 'black']
                  hotspots [label = 'Hotspots Análisis',  fillcolor =  'orange', color = 'white', fontcolor = 'black']
                  ...
                  ###
                  dal [label = 'Dalenius & Hodge',  fillcolor =  'orange', color = 'white', fontcolor = 'black']
                  hotspots2 [label = 'Hotspots Análisis',  fillcolor =  'orange', color = 'white', fontcolor = 'black']
                  pl [label = 'Power Law Análisis',  fillcolor =  'orange', color = 'white', fontcolor = 'black']
